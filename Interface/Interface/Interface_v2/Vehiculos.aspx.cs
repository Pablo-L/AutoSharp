...
namespace Interface_v2
{
    public partial class Vehiculos : System.Web.UI.Page
    {
        ...
        private void BindListView()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("SELECT Vehiculo.matricula,marca,modelo,anyo,color,imagen,Oferta.descripcion FROM Vehiculo left join Ofertado on (Vehiculo.matricula=Ofertado.matricula) left join Oferta on (Ofertado.codigo = Oferta.codigo)", con);
        ...
        private void BindListViewFilter()
        {
            ...
            {
                SqlDataAdapter sda = new SqlDataAdapter("SELECT Vehiculo.matricula,marca,modelo,anyo,color,imagen,Oferta.descripcion FROM Vehiculo left join Ofertado on (Vehiculo.matricula=Ofertado.matricula) left join Oferta on (Ofertado.codigo = Oferta.codigo) WHERE marca like '" + marca + "' and modelo like '" + modelo + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ListView1.DataSource = dt;
                ListView1.DataBind();
            ...
            else
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("SELECT Vehiculo.matricula,marca,modelo,anyo,color,imagen,Oferta.descripcion FROM Vehiculo left join Ofertado on (Vehiculo.matricula=Ofertado.matricula) left join Oferta on (Ofertado.codigo = Oferta.codigo) where marca like '" + marca + "' and modelo like'" + modelo + "' and anyo='" + year + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ListView1.DataSource = dt;
                ListView1.DataBind();
        ...
        protected void Filtrar2Vehiculo_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataBaseConnection"].ToString());
                SqlDataAdapter sda = new SqlDataAdapter("SELECT Vehiculo.matricula,marca,modelo,anyo,color,imagen,Oferta.descripcion FROM Vehiculo left join Ofertado on (Vehiculo.matricula=Ofertado.matricula) left join Oferta on (Ofertado.codigo = Oferta.codigo) where marca like '" + search + "' or modelo like '" + search + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ListView1.DataSource = dt;
                ListView1.DataBind();
