<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="OnlineQueryP.aspx.cs" Inherits="Interface_v2.Formulario_web1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Inicio" runat="server">
    <div style="width: 44%; margin: 0 auto;">
        ...
        <div style="float: right; padding: 10px; margin-top: 50px; margin-bottom: 50px">
            <asp:ImageButton ImageUrl="~/imagenes/query/query1.png" runat="server" AlternateText="Image text"/>
